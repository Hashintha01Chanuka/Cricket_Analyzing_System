...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleUpstreamUnavailable(MatchServiceUnavailableException ex) {
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE)
                .body(errorBody(HttpStatus.SERVICE_UNAVAILABLE, ex.getMessage()));
    }

    @ExceptionHandler(LiveStateNotAvailableException.class)
    public ResponseEntity<Map<String, Object>> handleLiveStateNotAvailable(LiveStateNotAvailableException ex) {
